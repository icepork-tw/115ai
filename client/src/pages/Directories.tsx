...
function PageHeader({ eyebrow, title }: { eyebrow: string; title: string }) {
  return <section className="directory-hero"><p className="eyebrow"><span /> {eyebrow}</p><h1>{title}</h1></section>;
}
